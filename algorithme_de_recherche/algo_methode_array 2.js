function recherchePrincipale(data, input){
    ...
    data.forEach(recette => {
        ...
        if(lowerCaseIngredients.includes(inputLowerCase) || lowerCaseTitre.includes(inputLowerCase) || lowerCaseDescription.includes(inputLowerCase)){
...
function rechercheParTag(data, input){
    ...
    data.forEach(recette => {
        ...
        // condition d'affichage des recettes en fonction du tri
        if(lowerCaseIngredients.includes(inputLowerCase) || lowerCaseUstensiles.includes(inputLowerCase) || lowerCaseAppliance.includes(inputLowerCase)){
            resultatRechcercheParTag.push(recette)
        }
    })
    console.log(resultatRechcercheParTag)
